...
public class Song extends AudioContent implements Comparable<Song>// implement the Comparable interface
{
	...
	{
		super.printInfo();
		System.out.println("Artist: " + this.artist + " ID: " + this.composer + " Genre: " + this.genre);
	}
	...
	public boolean equals(Object other)
	{
		...
		return (super.equals(other) && this.composer.equals(otherA.composer) && this.artist.equals(otherA.artist));
	}
