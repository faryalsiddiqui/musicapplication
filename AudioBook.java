...
public class AudioBook extends AudioContent
{
	...
	public void printTOC()
	{
		for (String chapterTitle: chapterTitles) {
			System.out.println("Chapter " + (chapterTitles.indexOf(chapterTitle) + 1)+ ". " + chapterTitle + '\n');
		}
	...
	{
		// prevents an error from raising if another AudioContent type is being compared
